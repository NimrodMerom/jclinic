  ...
  return (
    <div className="mt-8 border-t border-gray-200 pt-6">
      <div className="flex items-center justify-between">
        ...
        >
          <Database size={20} />
          {isOpen ? 'הסתר קוד SQL מעודכן' : 'הצג קוד SQL להתקנה (גרסה 2.3)'}
        </button>

        {isOpen && (
          <div className="flex items-center gap-3">
            <span className="text-[10px] font-black bg-green-100 text-green-700 px-2 py-1 rounded">V2.3 FINAL</span>
            <button 
              onClick={handleCopy}
      ...
      {isOpen && (
        <div className="mt-4 bg-slate-900 rounded-xl p-6 overflow-x-auto text-left shadow-2xl border border-slate-800 animate-in slide-in-from-bottom-2" dir="ltr">
          <div className="mb-4 flex items-center gap-2 text-amber-400 font-bold text-sm">
            <AlertCircle size={16} />
            נא להעתיק הכל ולהריץ ב-Supabase SQL Editor (גרסה 2.3 סופית)
          </div>
